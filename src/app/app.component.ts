...
export class AppComponent implements OnInit {
  roles: String[] = ['owner', 'active', 'memo', 'posting'];

//P5JWR1G87zmCiVv5CAYJA9Pgtdu1vYQ4d3kTWhsP7CJ2PgwFueMg
  username: string = 'youtarget5';
  password: string = 'qwerty12345'; // master password
  appName : string = 'yourtarget';
  keys: any;
  wif: string;
  ...
  ngOnInit(): void {
    ...
    this.keys = golos.auth.getPrivateKeys(this.username, this.password, [this.roles]);
    this.wif = this.keys.posting;

    console.log('getPrivateKeys', this.keys);
    console.log('is wif', golos.auth.isWif(this.wif));
